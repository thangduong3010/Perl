...
if (@ARGV[0] =~ /\bhelp\b/)
{
        print "ServerRequestsPerSec.pl SNMPver community hostname\n";
...
$results =  "";
$MIB= "APACHE2-MIB::serverRequestsPerSec.0";
...
while ($line = <OUTSTD>) {
	     ...
	     $val =~ s/[a-zA-Z\/\n ]//g;
	     print "Message: Server request per second at host \"$hostname\": $val\n";
	     print "Statistic: $val\n";
	     exit 0;
}
print "Statistic: 0\n";
