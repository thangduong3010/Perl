...
if (@ARGV[0] =~ /\bhelp\b/)
{
        print "ServerKBytesPerRequest.pl SNMPver community hostname\n";
...
$results =  "";
$MIB= "APACHE2-MIB::serverKBytesPerRequest.0";
...
while ($line = <OUTSTD>) {
	     ...
	     $val =~ s/[a-zA-Z\/\n ]//g;
	     print "Message: Kbytes per request at host \"$hostname\": $val\n";
	     print "Statistic: $val\n";
	     exit 0;
}
print "Statistic: 0\n";
